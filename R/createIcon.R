...
#' @param i_number The icon place in the rating input.
#' @param number The total number of icons in the rating input.
...
createIcon <- function(id,
  ...
  tag <- tags$div(
    ...
    style = sprintf(
      fmt = "display: flex; justify-content: center;align-items: center; color: %s; --animate-duration: %ss; %s; margin: 0; padding: 0;",
      init_color,
      i_duration,
      read_style
    ),
